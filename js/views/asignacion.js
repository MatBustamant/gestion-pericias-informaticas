...
window.init_asignacion = function() {
  ...
  pend.map(o=>{
    ...
    '<div class="solicitud-title">'+esc(o.imputado)+' s/ '+esc(o.delito)+'</div><div class="solicitud-details">'+ic('file',11,'var(--muted-fg)')+' '+esc(o.fiscal)+'&nbsp;&nbsp;·&nbsp;&nbsp;'+ic('pin',11,'var(--muted-fg)')+' '+esc(o.jur)+'&nbsp;&nbsp;·&nbsp;&nbsp;'+ic('clock',11,'var(--muted-fg)')+' Vence: '+esc(o.venc)+(o.nroIT?'&nbsp;&nbsp;·&nbsp;&nbsp;'+ic('hash',11,'var(--muted-fg)')+' '+esc(o.nroIT):'')+(o.fhi?'&nbsp;&nbsp;·&nbsp;&nbsp;'+ic('cal',11,'var(--muted-fg)')+' Apertura: <strong>'+fmtDT(o.fhi)+'</strong>':'')+'</div>'+

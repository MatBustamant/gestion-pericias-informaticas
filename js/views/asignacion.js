...
window.init_asignacion = function() {
  ...
  pend.map(o=>{
    ...
    return '<div class="solicitud-card'+(g?' confirmed':'')+'"><div class="solicitud-meta"><span class="td-mono">'+(o.tipo==='narco'?'NAR-':'GEN-')+esc(o.id)+'</span><span class="badges-right">'+ubdg(o.urgencia)+bdg(o.estado)+(g?'<span class="badge br">'+ic('checkC',10,'#065F46')+' Confirmado</span>':'')+'</span></div>'+

...
window.init_mesa_entrada = function() {
  ...
  document.getElementById('mesa-header').innerHTML = '<div><div class="page-title">Mesa de Entrada</div><div class="page-sub">'+S.solicitudes.length+' solicitudes registradas</div></div><div style="display:flex; gap:12px;"><button class="btn btn-primary" onclick="promptEditSolicitud()">'+ic('edit',15,'white')+' Modificar solicitud</button><button class="btn btn-primary" onclick="openModal(\'nueva-solicitud\')">'+ic('plus',15,'white')+' Registrar solicitud</button></div>';

...
window.init_mesa_entrada = function() {
  ...
  '<div><div class="fg-lbl">JURISDICCIÓN</div><div class="filter-pills"><button class="filter-btn'+(S.mesaJurisdiccion==='todos'?' active':'')+'" onclick="setMJ(\'todos\')">Todas</button>'+juris.map(j=>'<button class="filter-btn'+(S.mesaJurisdiccion===j?' active':'')+'" onclick="setMJ(\''+j+'\')">'+j+'</button>').join('')+'</div></div></div>':'';
